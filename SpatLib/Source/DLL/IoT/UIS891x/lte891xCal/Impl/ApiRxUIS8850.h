...
{
public:
    CApiRxUIS8850(LPCWSTR lpName, CFuncCenter* pFuncCenter);
    CApiRxUIS8850(const CApiRxUIS8850&obj) :CApiRxUIS8850(obj.m_lpFuncName,obj.m_pFuncCenter) {}
	virtual ~CApiRxUIS8850();
    CApiRxUIS8850& operator= (const CApiRxUIS8850&)
    {
        return *this;
    }
