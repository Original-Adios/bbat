#include "StdAfx.h"
#include "ApiRxUIS8910EMTC.h"
#include "math.h"
#include "assert.h"
#include "LteUtility.h"

CApiRxUIS8910EMTC::CApiRxUIS8910EMTC( LPCWSTR lpName, CFuncCenter* pFuncCenter ) : CApiBase(lpName, pFuncCenter)
{
...
CApiRxUIS8910EMTC::~CApiRxUIS8910EMTC()
{
...
SPRESULT CApiRxUIS8910EMTC::PreInit()
{
...
SPRESULT CApiRxUIS8910EMTC::Run()
{
...
SPRESULT CApiRxUIS8910EMTC::DoFunc()
{
...
SPRESULT CApiRxUIS8910EMTC::InsertGainIndex( int nBand, int nChannel, int nGain )
{
...
SPRESULT CApiRxUIS8910EMTC::InsertChannel( int nBand, int nChannel )
{
	BandData* pBandData = &(*m_parrBandData)[nBand];
	ChannelData* pChannelData = &pBandData->arrChannel[nChannel];
...
void CApiRxUIS8910EMTC::InitParam(int nBand, int nChannel, int nGain)
{
...
SPRESULT CApiRxUIS8910EMTC::GetData(uint32 nRetryCount)
{
    int i = 0;
    int j = 0;
    int k = 0;
...
SPRESULT CApiRxUIS8910EMTC::Init()
{
    return TRUE;
}

void CApiRxUIS8910EMTC::ClearData()
{
    uint32 iArrBandDataSize = m_parrBandData->size();
...
SPRESULT CApiRxUIS8910EMTC::SwitchCa()
{
...
SPRESULT CApiRxUIS8910EMTC::SetAgcParam()
{
