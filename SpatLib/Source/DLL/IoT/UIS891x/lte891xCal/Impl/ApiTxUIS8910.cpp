...
CApiTxUIS8910::CApiTxUIS8910( LPCWSTR lpName, CFuncCenter* pFuncCenter ) : CApiBase(lpName, pFuncCenter)
{
...
CApiTxUIS8910::~CApiTxUIS8910(void)
{
...
SPRESULT CApiTxUIS8910::PreInit()
{
...
SPRESULT CApiTxUIS8910::GetMaxPointsNumber()
{
    return SP_OK;
}

SPRESULT CApiTxUIS8910::InsertSection( BOOL* ret, int nBand, int nChannel, int nSection, BOOL bGap )
{
    LogFmtStrA(SPLOGLV_INFO, "%s", __FUNCTION__);
...
SPRESULT CApiTxUIS8910::InsertChannel( BOOL* ret, int nBand, int nChannel, int nSection )
{
    LogFmtStrA(SPLOGLV_INFO, "%s", __FUNCTION__);
    BandData* pBandData = &(*m_parrBandData)[nBand];
    ChannelData* pChannelData = &pBandData->arrChannel[nChannel];
...
void CApiTxUIS8910::InitParam( int nBand, int nChannel, int nSection )
{
    LogFmtStrA(SPLOGLV_INFO, "%s", __FUNCTION__);
...
SPRESULT CApiTxUIS8910::InsertTrigger( int nBand, int nChannel )
{
    LogFmtStrA(SPLOGLV_INFO, "%s", __FUNCTION__);
...
SPRESULT CApiTxUIS8910::SetApcParam()
{
	//V3
