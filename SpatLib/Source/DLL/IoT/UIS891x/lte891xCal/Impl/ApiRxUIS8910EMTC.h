...
using namespace std;
#pragma pack(push, 2)
class CApiRxUIS8910EMTC :
	public CApiBase,
	public IApiRx
{
public:
    CApiRxUIS8910EMTC(LPCWSTR lpName, CFuncCenter* pFuncCenter);
    CApiRxUIS8910EMTC(const CApiRxUIS8910EMTC&obj) :CApiRxUIS8910EMTC(obj.m_lpFuncName,obj.m_pFuncCenter) {}
	virtual ~CApiRxUIS8910EMTC();
    CApiRxUIS8910EMTC& operator=(const CApiRxUIS8910EMTC&)
    {
        return *this;
    }
