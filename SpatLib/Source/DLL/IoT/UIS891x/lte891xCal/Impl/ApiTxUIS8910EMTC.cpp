#include "StdAfx.h"
#include "ApiTxUIS8910EMTC.h"
#include "LteUtility.h"
#include "math.h"

CApiTxUIS8910EMTC::CApiTxUIS8910EMTC( LPCWSTR lpName, CFuncCenter* pFuncCenter ) : CApiBase(lpName, pFuncCenter)
{
...
CApiTxUIS8910EMTC::~CApiTxUIS8910EMTC(void)
{
...
SPRESULT CApiTxUIS8910EMTC::Run()
{
...
SPRESULT CApiTxUIS8910EMTC::PreInit()
{
...
SPRESULT CApiTxUIS8910EMTC::GetMaxPointsNumber()
{
    return SP_OK;
}

SPRESULT CApiTxUIS8910EMTC::InsertSection( BOOL* ret, int nBand, int nChannel, int nSection, BOOL bGap )
{
...
SPRESULT CApiTxUIS8910EMTC::InsertChannel( BOOL* ret, int nBand, int nChannel, int nSection )
{
    BandData* pBandData = &(*m_parrBandData)[nBand];
    ChannelData* pChannelData = &pBandData->arrChannel[nChannel];
    SectionData* pSectionData = &pChannelData->arrSection[nSection];
...
SPRESULT CApiTxUIS8910EMTC::DoFunc()
{
    IS_USER_STOP_FUNC;
...
void CApiTxUIS8910EMTC::GetData()
{
    int nPowerIndex = 1;
...
void CApiTxUIS8910EMTC::InitParam( int nBand, int nChannel, int nSection )
{
...
void CApiTxUIS8910EMTC::ClearData()
{
...
SPRESULT CApiTxUIS8910EMTC::InsertTrigger( int nBand, int nChannel )
{
    LogFmtStrA(SPLOGLV_INFO, "%s", __FUNCTION__);
...
SPRESULT CApiTxUIS8910EMTC::SetApcParam()
{
	//V3
