...
{
public:
    CApiTxUIS8910(LPCWSTR lpName, CFuncCenter* pFuncCenter);
    CApiTxUIS8910(const CApiTxUIS8910&obj) :CApiTxUIS8910(obj.m_lpFuncName,obj.m_pFuncCenter) {}
    virtual ~CApiTxUIS8910(void);
    CApiTxUIS8910& operator=(const CApiTxUIS8910&)
    {
        return *this;
    }
