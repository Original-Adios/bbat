...
{
public:
    CApiTxUIS8850(LPCWSTR lpName, CFuncCenter* pFuncCenter);
    CApiTxUIS8850(const CApiTxUIS8850&obj) :CApiTxUIS8850(obj.m_lpFuncName,obj.m_pFuncCenter) {}
    virtual ~CApiTxUIS8850(void);
    CApiTxUIS8850& operator=(const CApiTxUIS8850&)
    {
        return *this;
    }
