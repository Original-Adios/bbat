...
CLteClc_UIS8850::CLteClc_UIS8850(CImpBaseUIS8910 *pSpat)
...
CLteClc_UIS8850::~CLteClc_UIS8850(void)
{
}

SPRESULT CLteClc_UIS8850::Run()
{
...
SPRESULT CLteClc_UIS8850::Release()
{
    if (m_pFuncCenter != NULL)
    {
...
void CLteClc_UIS8850::Deserialization( std::vector<uint8>* parrData )
{
    m_pNal->Deserialization(parrData);
}

SPRESULT CLteClc_UIS8850::IniFuncMod( void )
{
#if 0
	BOOL bBand66 = FALSE;
