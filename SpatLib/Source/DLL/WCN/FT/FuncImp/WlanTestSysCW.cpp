...
#include "WlanMeasCW.h"
#include "WlanTestSysCW.h"
#include "WlanLoadXMLCW.h"
#include "SimpleAop.h"
//////////////////////////////////////////////////////////////////////////
//
IMPLEMENT_RUNTIME_CLASS(CWlanTestSysCW)

CWlanTestSysCW::CWlanTestSysCW(void)
: m_pEnterMode(NULL)
, m_pWlanMeas(NULL)
, m_pWlanAnt(NULL)
{
...
SPRESULT CWlanTestSysCW::__InitAction(void)
{
	...
	m_pWlanMeas = new CWlanMeasCW(this);
	if(NULL == m_pWlanMeas)
	{
		LogFmtStrA(SPLOGLV_ERROR, "new CWlanMeasCW failed!" );
		return SP_E_SPAT_ALLOC_MEMORY;
	}
	return SP_OK;
}

BOOL CWlanTestSysCW::LoadXMLConfig(void)
{
	auto _function = SimpleAop(this, __FUNCTION__);
	...
	CWlanLoadXMLCW* pLoadXml = NULL;
    pLoadXml = new CWlanLoadXMLCW(this);
	if(NULL == pLoadXml)
	{
		LogFmtStrA(SPLOGLV_ERROR, "new CWlanLoadXMLCW failed!" );
		return FALSE;
	}
...
SPRESULT CWlanTestSysCW::__PollAction( void )
{
...
void CWlanTestSysCW::__LeaveAction( void )
{
    
}

SPRESULT CWlanTestSysCW::__FinalAction(void)
{
	auto _function = SimpleAop(this, __FUNCTION__);
    if (NULL != m_pEnterMode)
    {
