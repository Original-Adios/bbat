#include "StdAfx.h"
#include <cassert>
#include "BTTestSysProbe.h"
#include "BTLoadXMLProbe.h"
#include "SimpleAop.h"
IMPLEMENT_RUNTIME_CLASS(CBTTestSysProbe)

CBTTestSysProbe::CBTTestSysProbe(void)
: m_pEnterMode(NULL)
, m_pBtApi(NULL)
...
SPRESULT CBTTestSysProbe::__InitAction(void)
{
...
BOOL CBTTestSysProbe::LoadXMLConfig(void)
{
	auto _function = SimpleAop(this, __FUNCTION__);
    ...
    CBTLoadXMLProbe *pLoadXml = new CBTLoadXMLProbe(this);	
	if(NULL == pLoadXml)
	{
...
SPRESULT CBTTestSysProbe::__PollAction( void )
{
...
void CBTTestSysProbe::__LeaveAction( void )
{
}

SPRESULT CBTTestSysProbe::__FinalAction(void)
{
    if (NULL != m_pEnterMode)
    {
        delete m_pEnterMode;
