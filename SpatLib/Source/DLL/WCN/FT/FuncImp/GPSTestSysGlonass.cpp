...
L6频段对应北斗的B3I频段
freq_id	含义
0x0	L1_GPS(1575.42MHz频点，包括GPS,B1C,GAL)
0x1	L1_B1I(1561.098MHz频点)
0x2	L1_GLO(1601.7188MHz频点)
0x3	L5(1176.45MHz频点)

************************************************************************/


IMPLEMENT_RUNTIME_CLASS(CGpsTestSysGlonass)

CGpsTestSysGlonass::CGpsTestSysGlonass(void)
//:m_pclGpsApi(NULL)
{
}
...
BOOL CGpsTestSysGlonass::LoadXMLConfig(void)
{
...
SPRESULT CGpsTestSysGlonass::__PollAction(void)
{
    return __super::__PollAction();
}

SPRESULT CGpsTestSysGlonass::GPS_MeasureEUT(GPSMeasParamChan* pGPSMeasParam)
{
	...
	CHKRESULT_WITH_NOTIFY_FUNNAME(GPS_SetSystemType(CPMODE_GLO_MASK));
...
SPRESULT CGpsTestSysGlonass::GPS_MeasureCW(GPSMeasParamChan* pGPSMeasParam)
{
	...
	GPS_SetSystemType(CPMODE_GLO_MASK);
