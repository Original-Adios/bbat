...
//////////////////////////////////////////////////////////////////////////
//
IMPLEMENT_RUNTIME_CLASS(CWlanTestSysSongShanW6)

CWlanTestSysSongShanW6::CWlanTestSysSongShanW6(void)
: m_pEnterMode(NULL)
, m_pWlanMeas(NULL)
, m_pWlanAnt(NULL)
{
...
SPRESULT CWlanTestSysSongShanW6::__InitAction(void)
{
...
BOOL CWlanTestSysSongShanW6::LoadXMLConfig(void)
{
	auto _function = SimpleAop(this, __FUNCTION__);
...
SPRESULT CWlanTestSysSongShanW6::__PollAction( void )
{
...
void CWlanTestSysSongShanW6::__LeaveAction( void )
{
    
}

SPRESULT CWlanTestSysSongShanW6::__FinalAction(void)
{
	auto _function = SimpleAop(this, __FUNCTION__);
    if (NULL != m_pEnterMode)
    {
