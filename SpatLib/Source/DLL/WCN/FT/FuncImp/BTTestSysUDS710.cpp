#include "StdAfx.h"
#include <cassert>
#include "BTTestSysUDS710.h"
#include "BTLoadXMLUDS710.h"
#include "SimpleAop.h"
IMPLEMENT_RUNTIME_CLASS(CBTTestSysUDS710)

CBTTestSysUDS710::CBTTestSysUDS710(void)
: m_pEnterMode(NULL)
, m_pBtApi(NULL)
...
SPRESULT CBTTestSysUDS710::__InitAction(void)
{
	...
	m_pBdrMeas = new CBTMeasBDRUDS710(this, m_pBtApi);
	if(NULL == m_pBdrMeas)
	{
		LogFmtStrA(SPLOGLV_ERROR, "new CBTMeasBDR fail!");
		return SP_E_SPAT_ALLOC_MEMORY;
	}
	m_pEdrMeas = new CBTMeasEDRUDS710(this, m_pBtApi);
	if(NULL == m_pEdrMeas)
	{
		LogFmtStrA(SPLOGLV_ERROR, "new CBTMeasEDR fail!");
		return SP_E_SPAT_ALLOC_MEMORY;
	}
	m_pBleExMeas = new CBTMeasBLEExUDS710(this, m_pBtApi);
...
BOOL CBTTestSysUDS710::LoadXMLConfig(void)
{
	auto _function = SimpleAop(this, __FUNCTION__);
    ...
    CBTLoadXMLUDS710 *pLoadXml = new CBTLoadXMLUDS710(this);
...
SPRESULT CBTTestSysUDS710::__PollAction( void )
{
...
void CBTTestSysUDS710::__LeaveAction( void )
{
}

SPRESULT CBTTestSysUDS710::__FinalAction(void)
{
	auto _function = SimpleAop(this, __FUNCTION__);
    if (NULL != m_pEnterMode)
    {
