...
//
IMPLEMENT_RUNTIME_CLASS(CImpWin32)

//////////////////////////////////////////////////////////////////////////
CImpWin32::CImpWin32(void)
: m_C_boolValue(FALSE)
{
...
BOOL CImpWin32::LoadXMLConfig(void)
{
    /*
...
SPRESULT CImpWin32::__InitAction(void)
{
...
void CImpWin32::__EnterAction(void)
{
...
SPRESULT CImpWin32::__PollAction(void)
{ 
...
void CImpWin32::__LeaveAction(void)
{
    // TODO: Cleanup internal resources
    m_vData.clear();
}

SPRESULT CImpWin32::__FinalAction(void)
{ 
