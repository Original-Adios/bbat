...
LPCSTR static g_lpAntNameAV4[MAX_LTE_RF_ANTENNA] = { "Ant0", "Ant1", "Ant2", "Ant3" };
...
#define FUNC_INVHelper L"INvHelper"
...
#define ALGO_MODEM_V4_APC L"algo apc"
#define ALGO_MODEM_V4_AGC L"algo agc"

#define ALGO_APC_SCAN_MAIN_PCC L"algo apc scan main pcc"
#define ALGO_APC_SCAN_DIV_SCC L"algo apc scan div scc"

#define ALGO_PDT_MAIN_PCC L"algo pdt main pcc"
#define ALGO_PDT_DIV_SCC L"algo pdt div scc"
...
#define ALGO_AGC_DISTORTION_SCAN L"algo agc distortion scan"
...
#define API_AGC_DISTORTION L"api agc distortion"

#define MAX_AGC_RETRY_COUNT 2
