...
{
public:
    CApiTxModV4(LPCWSTR lpName, CFuncCenter* pFuncCenter);
    virtual ~CApiTxModV4(void);
...
private:
    ...
    PC_MODEM_RF_V4_LTE_APC_REQ_CMD_T* m_pPhoneParamV4;
    ...
    std::vector<CALI_APC_ARFCN_V4_T> m_arrPhoneChannel;
