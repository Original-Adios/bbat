...
private:
    typedef CNvHelperV5::NvData_HelperInfo NvData_HelperInfo;

public:
    CNalGsV5(LPCWSTR lpName, CFuncCenter* pFuncCenter);
    ~CNalGsV5(void);
...
private:
    ...
    void HandleBand32(LTE_RF_ANTENNA_E Ant, int i, LTE_BAND_E Band);
