...
CAlgoClcTxModV4::CAlgoClcTxModV4( LPCWSTR lpName, CFuncCenter* pFuncCenter ) : CAlgoBase( lpName, pFuncCenter )
    , m_uMaxRetryTime( 30 )
{
	m_pNal = NULL;
	m_pFileConfig = NULL;
...
CAlgoClcTxModV4::~CAlgoClcTxModV4( void )
{

}

void CAlgoClcTxModV4::__SetAntCa()
{
	__super::__SetAntCa();
...
SPRESULT CAlgoClcTxModV4::PreInit()
{
...
SPRESULT CAlgoClcTxModV4::InitData()
{
...
SPRESULT CAlgoClcTxModV4::GetResultStatic( void* pCaller
                                      , BOOL* ret
                                      , uint32 uStartBand
                                      ...
                                      , uint32 uRetryTime )
{
    CAlgoClcTxModV4* pObject = ( CAlgoClcTxModV4* )pCaller;
...
SPRESULT CAlgoClcTxModV4::GetResult( BOOL* ret
                                , uint32 /*uStartBand*/
                                , uint32 /*uStartChannel*/
                                , uint32 /*uStartSection*/
                                , uint32 /*uStopBand*/
                                ...
                                , uint32 uRetryTime )
{
    ...
    *ret = TRUE;
    ...
    IsValidIndex(m_Ant)
	pResult->usAnt = m_pNv->m_pNvV4->m_arrGS_PortComp[m_ePortComp].Tx[m_UiAnt];
...
SPRESULT CAlgoClcTxModV4::SetLoss( double dLoss )
{
	int iTx0 = m_pNv->m_pNvV4->m_arrGS_PortComp[m_ePortComp].Tx[0];
	int iTx1 = m_pNv->m_pNvV4->m_arrGS_PortComp[m_ePortComp].Tx[1];
...
SPRESULT CAlgoClcTxModV4::Check()
{
    if ( m_arrarrBandData.size() == 0 )
    {
        return SP_OK;
