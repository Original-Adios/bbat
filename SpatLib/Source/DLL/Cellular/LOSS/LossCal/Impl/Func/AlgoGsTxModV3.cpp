...
CAlgoGsTxModV3::CAlgoGsTxModV3( LPCWSTR lpName, CFuncCenter* pFuncCenter ) : CAlgoBase(lpName, pFuncCenter)
, m_uMaxRetryTime(30)
{
	m_pNal = NULL;
	m_pFileConfig = NULL;
...
CAlgoGsTxModV3::~CAlgoGsTxModV3(void)
{


}

void CAlgoGsTxModV3::__SetAntCa()
{
	__super::__SetAntCa();
...
SPRESULT CAlgoGsTxModV3::PreInit()
{
...
SPRESULT CAlgoGsTxModV3::InitData()
{
...
SPRESULT CAlgoGsTxModV3::GetResultStatic( void* pCaller
                                    , BOOL* ret
                                    , uint32 uStartBand
                                    ...
                                    , uint32 uRetryTime )
{
    CAlgoGsTxModV3* pObject = (CAlgoGsTxModV3*)pCaller;
...
SPRESULT CAlgoGsTxModV3::GetResult( BOOL* ret
                              , uint32 uStartBand
                              , uint32 /*uStartChannel*/
                              , uint32 /*uStartSection*/
                              , uint32 uStopBand
